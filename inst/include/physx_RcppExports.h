...
#ifndef RCPP_physx_RCPPEXPORTS_H_GEN_
#define RCPP_physx_RCPPEXPORTS_H_GEN_
...
namespace physx {
    ...
    namespace {
        void validateSignature(const char* sig) {
            ...
            require("physx", Rcpp::Named("quietly") = true);
            typedef int(*Ptr_validate)(const char*);
            static Ptr_validate p_validate = (Ptr_validate)
                R_GetCCallable("physx", "_physx_RcppExport_validate");
            if (!p_validate(sig)) {
                throw Rcpp::function_not_exported(
                    "C++ function with signature '" + std::string(sig) + "' not found in physx");
            }
        }
    }
    ...
    inline List paircountxx(NumericMatrix x, double dr, double rmax) {
        ...
        if (p_paircountxx == NULL) {
            ...
            p_paircountxx = (Ptr_paircountxx)R_GetCCallable("physx", "_physx_paircountxx");
        }
    ...
    inline List paircountxy(NumericMatrix x, NumericMatrix y, double dr, double rmax) {
        ...
        if (p_paircountxy == NULL) {
            ...
            p_paircountxy = (Ptr_paircountxy)R_GetCCallable("physx", "_physx_paircountxy");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline List paircountxx1d(NumericVector x, double dr, double rmax) {
        ...
        if (p_paircountxx1d == NULL) {
            ...
            p_paircountxx1d = (Ptr_paircountxx1d)R_GetCCallable("physx", "_physx_paircountxx1d");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline List paircountxy1d(NumericVector x, NumericVector y, double dr, double rmax) {
        ...
        if (p_paircountxy1d == NULL) {
            ...
            p_paircountxy1d = (Ptr_paircountxy1d)R_GetCCallable("physx", "_physx_paircountxy1d");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
...
#endif // RCPP_physx_RCPPEXPORTS_H_GEN_
